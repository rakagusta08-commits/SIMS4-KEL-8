...
@section('title', 'Edit To-Do | SIM SEKOLAH')
...
<div class="form-container">
    <div class="form-header">
        <h1 class="mb-1 fw-bold">✏️ Edit To-Do</h1>
        <p class="opacity-75 mb-0">Perbarui detail tugas Anda</p>
    </div>
    ...
    <form action="{{ route('siswa.todo.update', $todo->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="text" id="judul_tugas" name="judul_tugas" class="form-control" 
                   ...
                   value="{{ old('judul_tugas', $todo->judul_tugas) }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea id="deskripsi" name="deskripsi" class="form-control" 
                      placeholder="Jelaskan detail tugas ini...">{{ old('deskripsi', $todo->deskripsi) }}</textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <select id="prioritas" name="prioritas" class="form-select" required>
                <option value="Rendah" {{ old('prioritas', $todo->prioritas) == 'Rendah' ? 'selected' : '' }}>
                    🟦 Rendah
                </option>
                <option value="Sedang" {{ old('prioritas', $todo->prioritas) == 'Sedang' ? 'selected' : '' }}>
                    🟨 Sedang
                </option>
                <option value="Tinggi" {{ old('prioritas', $todo->prioritas) == 'Tinggi' ? 'selected' : '' }}>
                    🟥 Tinggi
                </option>
            </select>
        </div>
